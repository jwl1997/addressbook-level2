...
Edits a person in the specific index. +
...
* `list` +
`edit 1 John Doe p/2345678 e/johnd@gmail.com a/John street, block 123, #01-01`
...
Edit the 2nd person in the results of the `find` command.
